...
const file_order_proto_rawDesc = "" +
	...
	"\fOrderService\x120\n" +
	"\bGetOrder\x12\x15.user.GetOrderRequest\x1a\v.user.Order\"\x00\x12B\n" +
	"\x11UpdateOrderStatus\x12\x1e.user.UpdateOrderStatusRequest\x1a\v.user.Order\"\x00B\x06Z\x04./pbb\x06proto3"
...
var file_order_proto_goTypes = []any{
	...
	(*UpdateOrderStatusRequest)(nil), // 2: user.UpdateOrderStatusRequest
	(*User)(nil),                     // 3: user.User
}
var file_order_proto_depIdxs = []int32{
	3, // 0: user.Order.user:type_name -> user.User
	1, // 1: user.OrderService.GetOrder:input_type -> user.GetOrderRequest
	2, // 2: user.OrderService.UpdateOrderStatus:input_type -> user.UpdateOrderStatusRequest
	0, // 3: user.OrderService.GetOrder:output_type -> user.Order
	0, // 4: user.OrderService.UpdateOrderStatus:output_type -> user.Order
